...
def training(dataset, hyper, opt, pipe, mode="feature", testing_iterations=None, saving_iterations=None, checkpoint_iterations=None, checkpoint=None, debug_from=None,num_classes = None):    
...
if __name__ == "__main__":
    ...
    training(lp.extract(args), hp.extract(args), op.extract(args), pp.extract(args), args.mode,  num_classes = args.num_classes)
