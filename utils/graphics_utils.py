...
#     P = torch.stack([
#         torch.tensor([2.0 * znear / (right - left), 0, (right + left) / (right - left), 0], requires_grad=True),
#         torch.tensor([0, 2.0 * znear / (top - bottom), (top + bottom) / (top - bottom), 0], requires_grad=True),
#         torch.tensor([0, 0, z_sign * zfar / (zfar - znear), -(zfar * znear) / (zfar - znear)], requires_grad=True),
#         torch.tensor([0, 0, z_sign, 0], requires_grad=True)
#     ])
