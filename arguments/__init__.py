...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False, scene_name=None):
        self.sh_degree = 3
        self._source_path = f"./data/hypernerf/{scene_name}/"  # ./data/uw/sardine  "./data/hypernerf/split-cookie-partial/"   ./data/hypernerf/{scene_name}/  ./data/URBAN/S2/
        self._model_path = ""   # output/hypernerf/broom2
        self._images = "images"
        self._resolution = -1
...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.feature_iterations = 30000 # 5_000
        ...
        self.stop_update_classifier = 8000
...
def get_combined_args(parser : ArgumentParser, target_cfg='scene', cmdlne_string = None):
    # 
