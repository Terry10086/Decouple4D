...
class Deformation(nn.Module):
    ...
    def query_time(self, rays_pts_emb, scales_emb, rotations_emb, time_feature, time_emb):
        ...
        if self.no_grid:
            ...
            hidden_before_mlp = hidden
        
        hidden = self.feature_out(hidden)   
 

        return hidden, hidden_before_mlp
    @property
    ...
    def forward_dynamic(self,rays_pts_emb, scales_emb, rotations_emb, opacity_emb, shs_emb, time_feature, time_emb):
        hidden, hidden_before_mlp = self.query_time(rays_pts_emb, scales_emb, rotations_emb, time_feature, time_emb)
        if self.args.static_mlp:
        ...
        return pts, scales, rotations, opacity, shs, dx, dr, ds, hidden_before_mlp
...
class deform_network(nn.Module):
    ...
    def forward_dynamic(self, point, scales=None, rotations=None, opacity=None, shs=None, times_sel=None):
        ...
        means3D, scales, rotations, opacity, shs, dx, dr, ds, hidden = self.deformation_net( point_emb,
                                                scales_emb,
                                                rotations_emb,
                                                opacity,
                                                shs,
                                                None,
                                                times_sel)  
        return means3D, scales, rotations, opacity, shs, dx, dr, ds, hidden
    def get_mlp_parameters(self):
